...
> **Palm Racer** 是一个集成了腾讯刷掌开放平台的开源 3D 体感赛车游戏，支持刷掌注册、刷掌登录和作弊检测，通过 MediaPipe 手掌追踪实现纯手势控制——无需手柄或键盘。

---

## 📖 简介 | Introduction

**Palm Racer（掌上赛车）** 是一个集成了[腾讯刷掌开放平台](https://palm.tencent.com)的体感竞速游戏。通过摄像头实时捕捉手掌姿态，控制 3D 赛车的转向、加速和刹车，并利用腾讯刷掌平台实现掌纹注册、掌纹登录和活体防作弊检测，支持 Web 浏览器与 Android 平台。
...
- 🔐 **腾讯刷掌平台集成 | Tencent Palm Platform** — 对接[腾讯刷掌开放平台](https://palm.tencent.com)，支持刷掌注册、刷掌登录和活体防作弊检测，实现安全可靠的掌纹身份认证
- 🖐️ **手掌体感控制 | Palm Gesture Control** — 基于 MediaPipe Hands 实时手掌追踪，无需手柄或键盘
...
|:---|:---|
| 掌纹身份认证 Palm Auth | [腾讯刷掌开放平台](https://palm.tencent.com)（注册/登录/活体防作弊） |
...
Palm Racer 通过后端代理对接[腾讯刷掌开放平台](https://palm.tencent.com)，集成了以下核心 API 能力：
...
Palm Racer 对接了腾讯刷掌开放平台，集成了以下核心能力：

- **刷掌注册** — 用户通过摄像头采集掌纹，完成掌纹特征注册，绑定游戏账号
- **刷掌登录** — 无需密码，刷掌即可完成身份认证并登录游戏
- **作弊检测** — 基于活体检测和掌纹真伪验证，防止照片/视频/模型等攻击手段，确保游戏公平性

这使得 Palm Racer 不仅是一个体感游戏，更是刷掌平台能力的完整集成示例。

### 可以用来学习吗？

当然可以！Palm Racer 基于 MIT 协议开源，非常适合作为以下技术的学习参考项目：

- **腾讯刷掌开放平台 API 集成**（掌纹注册、掌纹登录、活体防作弊检测）— 最完整的刷掌平台接入示例
- MediaPipe 手掌追踪集成
- Babylon.js 3D 游戏开发
...
- [腾讯刷掌开放平台](https://palm.tencent.com) — 提供刷掌注册、刷掌登录与作弊检测等核心掌纹身份认证能力
