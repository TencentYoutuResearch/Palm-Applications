...
本项目中的 3D 赛车模型来自 Sketchfab，使用 [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) 许可证，**不受 MIT 许可证覆盖**。详细的第三方资产归属信息请参阅 [THIRD_PARTY_NOTICES](THIRD_PARTY_NOTICES)。
